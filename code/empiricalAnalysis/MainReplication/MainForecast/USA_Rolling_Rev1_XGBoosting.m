...
%%%%%%%%%%%%%%%%%%%% SAMPLE SELECTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
rmax         = 10;             % Maximum number of factors allowed
vSparseLoad  = 1:NN;
...
%%%%%%%%%%%%%%%%%%%% SAVE OUTPUT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
full_table_boo = mse_boo(:,[6 100],:)./mse_ar(:,[6 100]);
file = 'USA_Rolling_Rev1_XGBoosting';
eval(['save ', file, ' -v7.3'])
...
file_name        = 'USA_Rolling_Rev1_XGBoosting.mat';
save(fullfile(output_folder, file_name), 'predBoosting','LearnCyc','LearnRate', '-v7.3');