function [weights, cf] = ir(A,F,varargin)
%
% The Inverse Ranking method to an error measure to combine individual
% forecasts. The function ranks the individual forecasts models based on their performance.
