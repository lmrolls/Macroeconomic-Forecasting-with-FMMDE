...
filename = 'Simulation_ResultsTAB3.xlsx';
sheet = 'Table3';
...
disp('Results saved to Simulation_ResultsTAB3.xlsx');
...
% This script generates the complete, wrapped LaTeX table for Table 3.
fprintf('Simulations for Table 3 finished. Generating LaTeX code...\n');

% Define Parameters and Open File
filename_latex = 'table3_final_version.tex';
...
% Updated caption for Table 3
fprintf(fid, '  \\caption{Empirical probability of estimating the true number of factors for n=200, T=100 (upper) and n=100, T=200 (lower).}\n');
% Updated label for Table 3
fprintf(fid, '  \\label{tab:full_simulation_table_3}\n');
...
% Generate the Upper Part of the Table (n=200, T=100)
% Point to the correct results for Table 3
results_seq_upper = finalTable.sequentialTest_n200_T100;
results_eigen_upper = finalTable.eigenvalueRatio_n200_T100;
...
% Generate the Lower Part of the Table (n=100, T=200)
% Point to the correct results for Table 3
results_seq_lower = finalTable.sequentialTest_n100_T200;
results_eigen_lower = finalTable.eigenvalueRatio_n100_T200;
...
fprintf('Success! Final LaTeX table for Table 3 saved to %s\n', filename_latex);


% Helper function to write one part of the table (no changes needed here)
